...
import { ArrowLeft, Store, Mail, Lock, User, Loader2, Phone, MapPin, Sparkles, UserPlus } from 'lucide-react';
...
export default function SellerSignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Signup
      const user = signup(formData.name, formData.email, formData.password, 'seller');
      ...
      >
        ...
        <Card className="shadow-2xl backdrop-blur-sm bg-white/95 border-0 overflow-hidden">
          <CardHeader className="space-y-4 pb-6 relative">
            ...
            >
              <CardTitle className="text-3xl font-bold bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent">Become a Seller</CardTitle>
              <p className="text-gray-600 mt-2 flex items-center justify-center gap-2">
                <UserPlus className="w-4 h-4 text-purple-600" />
                Start selling on IndieVerse today
              </p>
            </motion.div>
          </CardHeader>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              >
                ...
                <div className="relative group">
                  <User className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 w-5 h-5 group-focus-within:text-purple-600 transition-colors" />
                  <Input
                    type="text"
                    name="name"
              ...
              >
                ...
                <div className="relative group">
                  <Store className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 w-5 h-5 group-focus-within:text-purple-600 transition-colors" />
                  <Input
                    type="text"
                    name="businessName"
              ...
              >
                <div className="space-y-2">
                  ...
                  <div className="relative group">
                    <Phone className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 w-5 h-5 group-focus-within:text-purple-600 transition-colors" />
                    <Input
                      type="tel"
                      name="phone"
                      placeholder="Phone"
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative group">
                    <MapPin className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 w-5 h-5 group-focus-within:text-purple-600 transition-colors" />
                    <Input
                      type="text"
                      name="location"
                      placeholder="City"
              ...
              >
                <label className="flex items-start cursor-pointer group">
                  <input type="checkbox" className="mr-2 mt-1 w-4 h-4 accent-purple-600 cursor-pointer" required />
            ...
            >
              <p className="text-gray-600 text-sm">
                ...
                <Link href="/seller/login" className="text-purple-600 hover:text-purple-700 font-semibold transition-colors">
                  Login
                </Link>
              </p>
            </motion.div>
            ...
            >
              <Link href="/buyer/signup" className="text-sm text-gray-600 hover:text-gray-900 transition-colors inline-flex items-center gap-2 group">
                Want to buy instead? <span className="text-green-600 font-semibold group-hover:gap-3 transition-all">Sign up as Buyer →</span>
              </Link>
            </motion.div>
          </CardContent>
        </Card>
